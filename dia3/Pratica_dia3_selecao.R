...
FST_AFR_EAS <- read.table("AFR_EAS_maf.weir.fst", header=F, skip=1, col.names=names_header)
FST_AFR_EUR <- read.table("AFR_EUR_maf.weir.fst", header=F, skip=1, col.names=names_header)
FST_EAS_EUR <- read.table("EAS_EUR_maf.weir.fst", header=F, skip=1, col.names=names_header)
